...
export default function EmployeeLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("employeeId", data.employeeId || ""); // EMP_006
      localStorage.setItem("id", data.id || ""); // numeric DB ID
      ...
      if (err.response) {
        ...
        if (status === 404) {
          setErrorEmail(
            "⚠️ User not found. Please check your email or register."
          );
        } else if (status === 401) {
  ...
  return (
    <div
      ...
      style={{
        ...
        width: "100vw",
        background:
          "linear-gradient(135deg, #6dd5fa 0%, #2980b9 50%, #ffffff 100%)",
        padding: "0",
        margin: "0",
      }}
    >
